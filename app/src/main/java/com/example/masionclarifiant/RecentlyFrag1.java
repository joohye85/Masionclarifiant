...
public class RecentlyFrag1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable final ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.recently_purchased_fragment1,container,false);
        ...
        RecentlyFragRequest recentlyFragRequest = new RecentlyFragRequest(res);
        RequestQueue queue = Volley.newRequestQueue(RecentlyFrag1.super.getContext());
        queue.add(recentlyFragRequest);
